...
const terminalTabs: TabContent[] = [
  {
    ...
    lines: [
      ...
      { text: "鈹?, color: muted, delay: 60 },
      { text: "鈹? finance-market-analysis  10 skills  Analysis via yfinance + A/H iFinD API routing", color: secondary, delay: 100 },
      { text: "鈹? finance-social-readers    5 skills  Twitter, Discord, LinkedIn, Telegram, YC", color: secondary, delay: 100 },
      { text: "鈹? finance-data-providers    4 skills  A/H iFinD API, Sentiment, Funda AI, Hormuz APIs", color: secondary, delay: 100 },
